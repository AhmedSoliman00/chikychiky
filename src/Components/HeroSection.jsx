      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a key={item.name} href={item.href} className="text-base font-semibold leading-6 text-white hover:text-orange-500">
                {item.name}
              </a>
            ))}
          </div>
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="#" className="text-base font-semibold leading-6 text-white hover:text-orange-500">
      ...
      <div className="relative h-screen isolate overflow-hidden pt-14">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300 sm:px-50">
             Your One-Stop Destination for Farm-Fresh, Mouth-Watering, 
             and Responsibly Raised Chicken. Experience the Unmatched 
             Taste of Our Variety of Chicken Dishes, Prepared with Love 
             and Served with a Smile. Join Us on a Culinary Journey that
              Celebrates the Richness of Chicken, Straight from the Farm to 
              Your Plate. Chiki Chiki - Where Flavor Meets Freshness!
            </p>
